	...
	<body>
		...
		<header>
			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				<div class="container-fluid" role="alert">
					<a class="navbar-brand" href="{{ route('urls.create') }}">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							<li class="nav-item">
								<a class="nav-link active" aria-current="page" href="{{ route('urls.create') }}">Главная</a>
							</li>
							<li class="nav-item">
		...
		<main>
			...
			<section class="container my-5">
				<h1>Тэг decription</h1>
				<p class="text-wrap">Содержимое метатега description является <a href="https://yandex.ru/support/webmaster/search-results/site-description.html#changing-header-description">одним из источников</a>, на основе которых формируются описания страниц сайта в результатах поиска Яндекса. В сниппет попадает наиболее информативный и релевантный поисковому запросу текст. Кроме этого, описание может формироваться на основе содержимого страницы, поэтому пользователи могут увидеть разный контент — в зависимости от поискового запроса.</p>
				...
				<p><strong>Обычно метатег размещается внутри элемента head:</strong></p>
				<div class="d-flex justify-content-center"><pre><code>&lt;head&gt;
&lt;meta name="description" content="..."/&gt;
&lt;/head&gt;
				</code></pre></div>
				<p><strong>При составлении description следуйте рекомендациям:</strong>
